...
<div class="b_container">
    ...
    <h2>利用規約</h2>
    この利用規約（以下，「本規約」といいます。）は，MemoryMap（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
    ...
    <h3>第4条（サービスの終了について）</h3>
    本サービスは突如終了する可能性があります
    <h3>第5条（禁止事項）</h3>
